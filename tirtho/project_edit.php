...
if(isset($_GET['id'])) {
    ...
    $result = mysqli_query($db, "SELECT * FROM project WHERE id=$id");
    ...
    if(isset($_POST['update_submit'])) {
        ...
        // if everything is ok, try to upload file
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                ...
                $update_query = "UPDATE project SET name='$name', description='$description', link='$link', image='$target_file' WHERE id=$id";
