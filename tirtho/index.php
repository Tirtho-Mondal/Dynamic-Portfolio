...
<div class="container_display">
		<span style="float:right;"><a href="upload.php"><button class="btn-primary">Upload  </button></a></span>
        <span></span>
        
        
		<span style="float:right;"><a href="about.php"><button class="btn-primary">About </button></a></span>
        <span></span>
        
		<span style="float:right;"><a href="project.php"><button class="btn-primary">Project </button></a></span>
		<br><br>
	<?php 
